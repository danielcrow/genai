...
@router.get("/getContactHistory",response_model=ContactHistory, summary="Get Contact Details", description="Get Contact Details", operation_id="GetContactDetails",openapi_extra=extendedTags)
def getContactDetails(Contact:str):
    if(Contact == "ABC123"):
...
@router.get("/getCarSpec",response_model=CarSpec, summary="Get Contact Details", description="Get Contact Details", operation_id="GetContactDetails",openapi_extra=extendedTags)
